...
func (this GeneralAPI) Landing(c *gin.Context) {
	...
	page = strings.Replace(page, "Buldar | Comunidad de tecnología, geeks y más", "Buldar | Comunidad de Videojuegos, PC, Tecnología y más", 1)
	page = strings.Replace(page, "{{ page.title }}", "Buldar | Comunidad de Videojuegos, PC, Tecnología y más", 1)
